var isBatchAtomiclyValid = require('./isBatchAtomiclyValid')
...
module.exports = function chooseOptimization(idPropertyName, oldProxy, newProxy, protocol) {
    ...
    var isBatchValid = isBatchAtomiclyValid(diffs, protocol)
